    ...
    <div className="text-fg1 mx-auto flex min-h-screen max-w-prose flex-col justify-center py-4 md:py-20">
      <div className="h-[520px] space-y-10 px-4">
        <div className="items-top flex justify-between">
          <h1 className="text-fg0 text-2xl font-bold text-pretty">Avatar Prototype 1</h1>
          <div className="mt-1">
        ...
        <p>
          A customized LiveKit voice agent popup widget with avatar logo, Italian speech bubble, and
          connecting message.
        </p>
